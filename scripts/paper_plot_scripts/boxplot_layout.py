...
head_dir = '/home/ubuntu/pacset/scripts/paper_plot_scripts/logs_correct_landsat_682'
...
if sys.argv[2] == 'violin' or sys.argv[2] == 'Violin':
    ...
    plt.xlabel('layout')
    if block_or_lat == 'blocks' or block_or_lat == 'Blocks':
        plt.ylabel('Number of I/O Blocks')
    else:
        plt.ylabel('Latency(ms)')

plt.tight_layout()
plt.savefig(os.path.join(save_dir, 'Layout_vs_' + block_or_lat + '_'+ sys.argv[2] + '_' + sys.argv[3] +'.eps'), format='eps')
