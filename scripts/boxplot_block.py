...
layout_filepath_list = [
                        'Blocks_bfsthreads_1intertwine_0.csv',
                        'Blocks_dfsthreads_1intertwine_0.csv',
                        'Blocks_statdfsthreads_1intertwine_0.csv',
                        'Blocks_blockstatthreads_1intertwine_0.csv',
                        'Blocks_blockstatclassthreads_1intertwine_0.csv'
                        ]
