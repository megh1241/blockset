...
layout_filepath_list = [
                        ...
                        'latency_blockstatthreads_1intertwine_1.csv',
                        'latency_blockstatthreads_1intertwine_2.csv',
                        'latency_blockstatthreads_1intertwine_3.csv',
                        'latency_blockstatthreads_1intertwine_4.csv',
                        ]
...
layout_names = ['No interleaving', '1 levels', '2 levels', '3 levels', '4 levels']
