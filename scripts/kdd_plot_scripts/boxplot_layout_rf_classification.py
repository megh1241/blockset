...
layout_names = ['BFS', 'DFS', 'WDFS', 'Block\nWDFS']
if bin_or_not == 'bin':
...
head_dir = 'logs_correct_landsat_682'
...
boxplot_df.to_pickle('Layout_vs_' + block_or_lat + '_'+ sys.argv[2]+ '.pkl')
...
fig.subplots_adjust(bottom=0.147, left=0.145, right=0.9945, top=1.2)
...
fig.savefig('Layout_vs_' + block_or_lat + '_'+ sys.argv[2]+'.pdf', fbbox_inches='tight')
