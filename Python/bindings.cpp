...
py::class_<PacsetBase>(m, "PacsetBase")
	.def(py::init<>())
	.def("randomForestClassifier", &PacsetBase::randomForestClassifier)
	.def("randomForestRegressor", &PacsetBase::randomForestClassifier)
	.def("gradientBoostedClassifier", &PacsetBase::randomForestClassifier)
	.def("gradientBoostedRegressor", &PacsetBase::randomForestClassifier)
